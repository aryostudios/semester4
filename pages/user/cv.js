            ...
            <div className="container">
              <div className="work-experience group">
                ...
                <div className="item">
                  ...
                  <p className="text-muted">
                    ...
                    Aenean eget velit ultricies, feugiat est sed, efficitur
                    nunc, vivamus vel accumsan dui.
                  </p>
                </div>
                <div className="item">
                  <div className="row">
              ...
              <div className="hobbies group">
                ...
                <p className="text-center text-muted">
                  ...
                  risus ligula, iaculis ut metus sit amet, luctus pharetra
                  mauris. Aliquam purus felis, pretium vel pretium vitae,
                  dapibus sodales ante. Suspendisse potenti. Duis nunc eros.
                </p>
              </div>
            </div>
          </section>
